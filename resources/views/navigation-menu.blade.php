<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-L1yAb9XW/S2Kk0NsP5J5OXc27YfDpLlI
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('imagens/logo.png') }}" alt="Logo" style="max-width: 130px;">
                    </a>
                </div>
                <!-- Navigation Links -->
