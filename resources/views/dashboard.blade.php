            ...
            <table class="table-auto w-full">
              ...
              <script>
                document.getElementById('equipamento').addEventListener('change', function() {
                  ...
                  document.getElementById('export-csv-btn').href = "{{ route('nobreaks.export.id', ['id' => ':id']) }}".replace(':id', selectedEquipamento);
                });
              </script>
              ...
              <table class="table-auto w-full" id="tabelaLogs">
                <thead>
                  <tr>
                    <th class="px-4 py-2 font-bold bg-gray-100 border-b border-gray-200">Data de Cadastro</th>
    ...
    success: function(data) {
      ...
      tabela.fadeOut('fast', function() {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          tr.append($('<td>').text(log.data_cadastro));
